...
import { Download, FileSpreadsheet, FolderOpen, Save, Trash2 } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const loadTemplates = async () => {
      ...
      try {
        ...
        const firstName = Object.keys(normalized)[0] || DEFAULT_TEMPLATE_NAME;
        setTemplates(normalized);
        setSelectedTemplate(firstName);
