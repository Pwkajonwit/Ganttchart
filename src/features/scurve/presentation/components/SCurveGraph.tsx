            ...
            <div className="sticky top-0 w-full border-b border-gray-200 bg-white/90 backdrop-blur-sm relative group/chart shadow-sm"
                ...
                <div className="absolute top-4 right-14 bg-white/95 p-3 rounded-lg border border-gray-200 shadow-sm z-50 flex flex-col gap-2 pointer-events-auto min-w-[180px]">
                    ...
                    <div className="flex items-center gap-2 justify-between">
                        ...
                        <span className="text-xs text-gray-500">{planAtAnchorPoint ? (planAtAnchorPoint.plan || 0).toFixed(1) : 0}%</span>
                    </div>
                    <div className="flex items-center gap-2 justify-between">
                        <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-500">{lastActualPoint ? (lastActualPoint.actual || 0).toFixed(1) : 0}%</span>
                    </div>
                ...
                <svg width={width} height={height} className="overflow-hidden">
                    ...
                    {planAtAnchorPoint && (() => {
                        ...
                        const label = `Plan ${(planAtAnchorPoint.plan || 0).toFixed(1)}%`;
                    ...
                    {lastActualPoint && (() => {
                        ...
                        const label = `Actual: ${(lastActualPoint.actual || 0).toFixed(1)}%`;
                        const width = 65;
                        return (
                            <g>
